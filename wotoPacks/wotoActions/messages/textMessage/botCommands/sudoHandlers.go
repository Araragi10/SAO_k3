...
func testCommandHandler(message *tg.Message, args *pTools.EventArgs) {
	wotoTest.TestCommandHandle(message, args)
}

func sudoCommandHandler(message *tg.Message, args *pTools.EventArgs) {
	wotoSudo.Sudo_handler(message, args)
}

func patCommandHandler(message *tg.Message, args *pTools.EventArgs) {
